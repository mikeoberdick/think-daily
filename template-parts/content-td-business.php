<?php
/**
 * THINK DAILY BUSINESS BLOG TEMPLATE
 *
        ...
        <div class = "container">
          <div class="row">
            <div id = "blogHeaderLeft" class="col-md-6">
              <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/think_daily_logo_businesspeople.png" alt="Think Daily for Businesspeople by Larry Janesky">
              ...
              <p>Click <a href="/">here</a> to view Think Daily.</p>
            </div><!-- .col.md-6 -->
...
<main id = "main" class = "site-main">
  <div class="container">
    <div class="row">
      <div class="col-sm-12">
      <h2 id = "blogPageTitle">Today's Think Daily for Businesspeople Message</h2>
      <?php 
      $args = array(
        'cat' => '2',
        'posts_per_page' => '1'
...
?>
  ...
  <div id="archiveLink"> 
       <a href = '<?php echo bloginfo('url'); ?>/think-daily-for-businesspeople-archive'>View Full Think Daily for Businesspeople Archive</a>
  </div>
</main>
