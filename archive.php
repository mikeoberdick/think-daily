...
if ( $category == "think-daily-for-businesspeople") { get_header(); ?>
...
<?php $yearSlashMonth = trim($_SERVER[REQUEST_URI],'//');
    ...
    <div id = "thinkDaily">
      <div id = "thinkDailyArchiveHeader" class="container-fluid" style = "background:url('<?php echo get_stylesheet_directory_uri(); ?>/img/think_daily_bg.jpg');">
        <div class = "container">
          <div class="row">
            <div class="col-sm-12 text-center">
              <a href="/"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/think_daily_logo.png" alt="Think Daily by Larry Janesky"></a>
